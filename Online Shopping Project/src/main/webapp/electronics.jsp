...
.product-col-left{
    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)), url("https://tse4.mm.bing.net/th?id=OIP.20-yFLyYwRVRUObi3Px3vAAAAA&pid=Api&P=0&w=294&h=160") center/cover no-repeat;
	hieght:200;
}
.product-col-r-top{
...
@media screen and (min-width: 1336px){
    ...
    <body>
        ...
        <div class = "products">
            <div class = "container">
                <h1 class = "lg-title">Special ELECTRONICS With Offers</h1>
                <p class = "text-light">"ELECTRONICS WHICH MAKES LIFE EASIER"</p>
                ...
                <div class = "product-items">
                    ...
                    <div class = "product">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">iphone 7 ,black color 
                                32GB/128GB/256GB storage</a>
                    ...
                    <div class = "product">
                        ...
                        <div class = "product-info">
                            ...
                            <p class = "product-price">₹4500.0</p>
                    ...
                    <div class = "product">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">sony video recorder high64 mega pixcel </a>
                            <p class = "product-price">₹11250</p>
                ...
                <div class = "product-collection-wrapper">
                    ...
                    <div class = "product-col-left flex">
                        <div class = "product-col-content">
                            <h2 class = "sm-title">top brands </h2>
                            <h2 class = "md-title" style="color: black;">New collection-electronics </h2>
					<img src ="https://tse4.mm.bing.net/th?id=OIP.20-yFLyYwRVRUObi3Px3vAAAAA&pid=Api&P=0&w=294&h=160"  width="275%" height ="350" alt = "product image">
                    ...
                    <div class = "product-col-right">
                        <div class = "product-col-r-top flex">
                            <div class = "product-col-content">
                                ...
                                <h2 class = "md-title" style="color: black;">electronics collection-home</h2>
					<img src="https://st2.depositphotos.com/1496387/7584/v/950/depositphotos_75848829-stock-illustration-household-appliances-vector-logo-design.jpg" width="250" height="300" alt="product image">
                                <button type = "button" class = "btn-dark">Shop now</button>
                            </div>
                        </div>
